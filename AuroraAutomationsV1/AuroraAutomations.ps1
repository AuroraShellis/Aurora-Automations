...
Function CreditsMenu {
	...
	$CreditsForm.CreditsOutput.AppendText("`nMatthew Westlake`nMicheal Chen - Email: aurora@chencorp.co.nz`nPogai (David) Tuiala`nRyan Alpay - Email: ryanmatthew.alpay@mail.com`n`n")
